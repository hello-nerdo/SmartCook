...
export default function RecipeDetailPage({ params }: { params: { id: string } }) {
  ...
  async function handleDeleteRecipe() {
    if (!recipe?.id || !window.confirm('Are you sure you want to delete this recipe?')) {
      return;
    }
    ...
    return (
      <div className="w-full max-w-4xl p-6 mx-auto">
        <div className="bg-white rounded-lg shadow-md p-6 text-center">
          ...
          <p className="text-charcoal-600 mb-6">{error || 'The recipe you're looking for could not be found.'}</p>
          <Link 
            href={pathToRecipes} 
      ...
      >
        ...
        <div className="p-6">
          <div className="flex justify-between items-start mb-4">
            <h1 className="text-3xl font-bold text-charcoal-800">{recipe.title}</h1>
            <button
